#Welcome to the Hydroclimate Data Pipeline for Vulnerability Runoff!
#This tool generates vulnerability rasters based on CN-SCS methodology
...
pipeline_polygon <- c("Warszawa", "Warszawski zachodni", "Sochaczewski")
#pipeline_polygon <- "../user/user.shp"
